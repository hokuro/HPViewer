...
public class EntityConfigurationEntry {
	...
	public static EntityConfigurationEntry generateDefaultConfiguration(Configuration config, Class entry) {
		...
		if (entry == EntityIronGolem.class) {
			...
			scaleFactor = 10.0F;
		} else if ((EntityList.field_75626_c.get(entry) != null)
				&& (((String) EntityList.field_75626_c.get(entry)).equalsIgnoreCase("Linkbook"))) {
			ignore = true;
		}
	...
	public static EntityConfigurationEntry loadEntityConfig(Configuration config, EntityConfigurationEntry ece,
		...
		String ConfigName;
		if (EntityList.field_75626_c.containsKey(entry)) {
			ConfigName = I18n.func_74838_a((String) EntityList.field_75626_c.get(entry)) + " - " + mod;
		} else {
