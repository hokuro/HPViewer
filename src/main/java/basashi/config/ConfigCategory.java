...
import static basashi.config.Configuration.*;
...
public class ConfigCategory implements Map<String, Property>
{
    ...
    private void write(BufferedWriter out, boolean new_line, String... data) throws IOException
    {
        ...
        if (new_line) out.write(basashi.config.Configuration.NEW_LINE);
    }
    ...
    public void write(BufferedWriter out, int indent) throws IOException
    {
        ...
        {
            write(out, pad0, basashi.config.Configuration.COMMENT_SEPARATOR);
            write(out, pad0, "# ", name);
            write(out, pad0, "#--------------------------------------------------------------------------------------------------------#");
            ...
            write(out, pad0, basashi.config.Configuration.COMMENT_SEPARATOR, basashi.config.Configuration.NEW_LINE);
        }
        ...
        write(out, pad0, "}", basashi.config.Configuration.NEW_LINE);
    }
